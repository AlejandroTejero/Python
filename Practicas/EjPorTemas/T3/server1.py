...
HOST = socket.gethostname() #IP de la maquina
PORT = 2000 #constante puerto

server_socket = socket.socket(socket.AF_INET, socket.SOCK_STREAM) #creacion del server del servidor
server_socket.bind((HOST, PORT)) #atas a tu maquina
server_socket.listen() #escuchas conexiones infinitas
